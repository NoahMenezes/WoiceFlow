    ...
    <div className="relative w-full bg-[#090a0f]">
      ...
      <nav className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-4 sm:px-6 md:px-10 py-4 sm:py-6">
        <div className="flex items-center gap-2 text-[#2d3a2a]">
          <span className="text-lg sm:text-xl md:text-2xl font-semibold tracking-tight">
            WoiceFlow<sup className="text-[10px] sm:text-xs font-medium">TM</sup>
          </span>
        </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center pt-24 sm:pt-28 md:pt-32 px-4 sm:px-6">
        ...
        <p className="mt-6 sm:mt-8 text-[#4b5b47] text-sm sm:text-base md:text-lg leading-relaxed max-w-xl px-2">
          Shape spoken thoughts into system-wide text instantly. WoiceFlow captures, transcribes offline using Whisper, and injects text into any application on <strong className="font-semibold">Linux, Windows, or macOS</strong> at 20x keyboard emulation speed.
        </p>
      </div>
      ...
      <div className="absolute left-4 right-4 sm:right-auto sm:left-6 md:left-10 bottom-6 sm:bottom-8 md:bottom-10 z-10 max-w-sm">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <a href="#setup" className="bg-[#3d5638] sm:bg-white hover:bg-[#2d4228] sm:hover:bg-white/90 text-white sm:text-[#1f2a1d] text-sm font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-full transition-colors shadow-sm">
            Get Started
          </a>
          <a href="#why" className="text-[#3d5638] sm:text-white text-sm font-semibold sm:font-medium hover:opacity-80 transition-opacity">
            Why Offline?
          </a>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 rounded-3xl bg-black/40 border border-white/10 space-y-4">
                ...
                <p className="text-sm text-[#cbd5e1] leading-relaxed">
                  WoiceFlow listens globally for <kbd className="px-2 py-0.5 rounded bg-white/10 text-white font-mono text-xs">F9</kbd> — no configuration needed after install. You can also map any shortcut in your system settings to run:
                </p>
                <div className="bg-black/60 rounded-xl p-3 font-mono text-xs text-[#85AB8B]">
                  # Cross-platform terminal command{"\n"}python ~/.local/share/woiceflow/main.py{"\n"}{"\n"}# Or just press F9 — it&apos;s already running!
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-black/40 border border-white/10 space-y-4">
                ...
                <p className="text-sm text-[#cbd5e1] leading-relaxed">
                  Upon first run, WoiceFlow downloads the low-footprint <strong>Faster-Whisper base</strong> model (~140MB). Change it anytime via your <code className="px-1.5 py-0.5 rounded bg-white/10 text-white font-mono text-xs">.env</code> file:
                </p>
                <div className="bg-black/60 rounded-xl p-3 font-mono text-xs text-[#85AB8B]">
                ...
                <div className="p-8 grid sm:grid-cols-2 h-full min-h-[300px] items-center">
                  <div className="relative z-10 flex flex-col justify-between space-y-12">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-[#cbd5e1]">Clean, user-space virtual inputs that do not violate OS safety policies or sandboxing rules — on Linux, Windows, or macOS.</p>
                    </div>
                  </div>
                ...
                <div className="p-8 grid sm:grid-cols-2 h-full min-h-[300px] items-center">
                  <div className="relative z-10 flex flex-col justify-between space-y-12">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-[#cbd5e1]">Developed by a network of cross-platform power users. Clean system commits, fully audited source, and runs on all major OS platforms.</p>
                    </div>
                  </div>
