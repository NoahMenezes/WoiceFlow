...
import { Cpu, Terminal, Shield, ArrowRight, BookOpen, Volume2, Key } from 'lucide-react';
    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div className="space-y-6 pt-6 border-t border-white/5">
        ...
        <p className="text-slate-400 text-sm">
          Select the operating system you are running to access targeted setup scripts, daemon loaders, and hardware virtualization guides.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/docs/linux" className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] hover:bg-[#85AB8B]/5 hover:border-[#85AB8B]/30 transition-all group">
          ...
          <Link href="/docs/windows" className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] hover:bg-[#85AB8B]/5 hover:border-[#85AB8B]/30 transition-all group">
            <div className="flex items-center gap-3">
          ...
          <Link href="/docs/macos" className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] hover:bg-[#85AB8B]/5 hover:border-[#85AB8B]/30 transition-all group">
            <div className="flex items-center gap-3">
